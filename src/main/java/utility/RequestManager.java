    ...
    public static List<RequestTask> execute(ArrayList<RequestTask> tasks, Boolean isDebug) throws Exception {
        ...
        if (isDebug) {
            switch (type) {
                ...
                case IMAGE:
                    return DBHandler.selectAllImages();
            }
        }
...
//                        log.log(Level.SEVERE, "Exception: ", e);
            ...
            if (result.size() > 0 && (result.size() > bufferSize || tasks.size() == 0)) {
                ...
                switch (type) {
                    case ITEM:
                        ...
                        break;
                    case IMAGE:
                        DBHandler.addAvitoImages(items);
                        break;
                }
            }
        }
        ...
        return type == ReqTaskType.ITEM ? DBHandler.selectAllItems() : DBHandler.selectAllImages();
    }
