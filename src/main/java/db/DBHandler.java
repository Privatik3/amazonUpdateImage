...
public class DBHandler {
    ...
    static {
        try {
            conn = DriverManager.getConnection("jdbc:h2:C:/Developers/amazonUpdateImage/cache");
    ...
    public static void addAvitoImages(ArrayList<RequestTask> items) {
        addToTable(items, "AVITO_IMAGES");
    }
    ...
    public static List<RequestTask> selectAllImages() {
        return select("AVITO_IMAGES");
    }
    ...
    public static void clearAvitoImages() {
        clearTable("AVITO_IMAGES");
    }
